...
export class NavBar {
  static createHTML(user, activePage = 'dashboard', userRole = 'user') {
                  ...
                  <li class="dropdown-header">
                    <div class="d-flex align-items-center gap-2">
                      ...
                      <div>
                        ...
                        <div class="user-status">${isAdmin ? 'Admin' : 'Active'}</div>
                      </div>
                    </div>
                  </li>
                  <li><hr class="dropdown-divider"></li>
                  ${isAdmin ? `
                    <li><a class="dropdown-item" href="#/admin"><i class="bi bi-shield-lock-fill"></i> Admin Panel</a></li>
                  ` : ''}
